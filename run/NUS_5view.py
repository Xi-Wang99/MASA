...
if __name__ == '__main__':
    ...
    # parser.add_argument('--root', default='/home/wangxi/dsn_multiview/data')
    ...
    train_sampler = CategoriesSampler(trainset.label, [0, 25], 100,
                                      args.train_way,
    ...
    val_sampler = CategoriesSampler(valset.label, [25, 31], 400,
                                    args.test_way,
